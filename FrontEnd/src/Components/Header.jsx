...
const Header = () => {
  return (
    <nav className='fixed z-50 w-full py-5 px-7 flex justify-between items-center bg-[#00000039] backdrop-blur-2xl '>
      <Link to="/" className='text-3xl font-bold text-yellow-300'>OptiJS</Link>
      <ul className='flex items-center gap-7 font-bold text-yellow-300'>
